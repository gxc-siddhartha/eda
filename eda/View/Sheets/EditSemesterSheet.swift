        ...
        NavigationStack {
            List {
                Section {
                    Picker(
                        "Selected Semester",
                        selection: $semesterViewModel.editSemesterName
                    ) {
                ...
                Section("Attendance Requirement") {
                    HStack {
                        ...
                        TextField(
                            "75",
                            text: $semesterViewModel.editedPassingPercentage
                        )
                    }
                ...
                Section("Start Date") {
                    DatePicker(
                        "Start Date",
                        selection: $semesterViewModel.editSemesterStartDate,
                ...
                Section("End Date") {
                    DatePicker(
                        "Start Date",
                        selection: $semesterViewModel.editedEndDate,
                        displayedComponents: .date
                    )
                    .datePickerStyle(.graphical)
                }

            }.navigationTitle(Text("Edit Semester"))
